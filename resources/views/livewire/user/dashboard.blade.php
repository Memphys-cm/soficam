<x-layouts.user.master>
    <div class='container pt-3 pt-lg-4 pb-3 pb-lg-6 text-white'>
        <div class='d-flex flex-wrap-reverse align-items-top  justify-content-md-between '>
            <div class='d-flex flex-wrap align-items-center gap-3'>
                ...
                <div class=''>
                    <div class='fw-bold display-4 text-gray-600'>{{ __('Bonjour') }}, {{ auth()->user()->first_name }}
                    </div>
    ...
    <div class="">
        ...
        <div class="mb-3">
            <a href="{{ route('user.taxfonciere.index') }}" class="btn btn-primary">
