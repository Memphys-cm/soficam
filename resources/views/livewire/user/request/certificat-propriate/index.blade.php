                            ...
                            @forelse($certificats as $certificat)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($certificat->link_tresor_pay)
                                            <a href="{{ route('tresor_pay.certificat_pay', ['uuid' => $certificat->uuid ?? null]) }}"
                                                target="blank" class="btn btn-primary" title="Go Tresor Pay">
                                                {{ __('Go Tresor Pay') }} 
                                            </a>
                                        @else
                                            {{ __('No Action') }}
