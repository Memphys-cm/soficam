...
<div class="container-fluid">
    ...
    <div style="margin-top: 8vh">
        <p></p>
        <h3 style="text-align: center;">CERTIFICAT DE PROPRIETE
            N°{{ $element->certificate_proprietes_number }}/CP/MINDCAF/2/35/T600</h3>
        <div style="font-size: 14px">
            <p>Le Conservateur de la Propriété et des Droits Fonciers du Département de
                ...
                certifie que
                l'immeuble rural non bati, exploité sis à <strong>{{ $element->titreFoncier->zone }}</strong> au lieu
                dit
                <strong>{{ $element->titreFoncier->lieu_dit }}</strong>
                d'une superficie initiale de {{ $element->titreFoncier->superficie_du_TF_mere }}m2 immatriculé au Livre
                Foncier du Département de la
                {{ $element->titreFoncier->division->division_name }}, Volume {{ $element->titreFoncier->volume }},
                Folio {{ $element->titreFoncier->numero_folio }} sous le numéro
                26773/MAF.
            </p>
            ...
            <p>Ledit Titre Foncier sur lequel le Duplicatum N°1 a été délivré: est à ce jour grevé d'une <strong>Clause
                ...
                il fait l'objet d'un morcellement d'une superficie de
                <strong>{{ $element->certificate_proprietes_number }}</strong>, suite à
                cette transaction, la superficie restante est de
                <strong>{{ $element->titreFoncier->superficie_restant_du_TF_mere }}m2</strong> conformément aux
                inscription
