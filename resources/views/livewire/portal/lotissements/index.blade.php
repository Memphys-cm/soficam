    ...
    <div class='p-0'>
        <div class="d-flex justify-content-between w-100 flex-wrap align-items-center">
            <div class="mb-lg-0">
                ...
                <p class="mt-n1 mx-2">{{__('View all lotissements')}} &#x23F0; </p>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" wire:click.prevent="initData({{$lotissement->id}})" data-bs-toggle="modal" data-bs-target="#ViewHousingEstateModal" draggable="false">
