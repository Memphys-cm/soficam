                ...
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item "><a
                                href="{{ route('portal.lotissements.index') }}">{{ __('Lotissements') }}</a></li>
        ...
        <div class='col-md-3 '>
            ...
            <div class="card p-3">
                ...
                <div class="d-flex align-items-center mb-2 border-1 border-bottom">
                    <span class="fw-light ">{{ __('Total Blocs') }}</span> : <span
                        class="fw-bolder mx-2">{{ count($lotissement->blocks) }} </span>
                </div>
                <div class="d-flex align-items-center mb-2 border-1 border-bottom">
                    <span class="fw-light ">{{ __('Total Lots') }}</span> : <span
                        class="fw-bolder mx-2">{{ count($lotissement->parcels) }} </span>
                </div>
                <div class="d-flex align-items-center mb-2 border-1 border-bottom">
                    <span class="fw-light ">{{ __('Total Lots publics') }}</span> : <span
                        class="fw-bolder mx-2">{{ count($lotissement->parcels->where('type', 'public')) }} </span>
                </div>
                <div class="d-flex align-items-center mb-2 border-1 border-bottom">
                    <span class="fw-light ">{{ __('Total Lot normal') }}</span> : <span
                        class="fw-bolder mx-2">{{ count($lotissement->parcels->where('type', 'normale')) }} </span>
                </div>
                <div class="d-flex align-items-center mb-2 border-1 border-bottom">
                    <span class="fw-light ">{{ __('Total Lots Vendus') }}</span> : <span
                        class="fw-bolder mx-2">{{ count($lotissement->parcels->where('date_de_vente', '<>', null)) }}
                    </span>
                </div>
                <div class="d-flex align-items-center mb-2">
                    <span class="fw-light ">{{ __('Total Lots Restants') }}</span> : <span
                        class="fw-bolder mx-2">{{ count($lotissement->parcels->where('date_de_vente', null)) }} </span>
                </div>
            </div>
            ...
            <div class="card p-4 mb-3">
                ...
                <div class='row gap-4'>
                    <div class="col">
                        <a href="#" class="d-flex align-items-center justify-content-between">
                            <div class="d-flex ">
                                <div
                                    ...
                                    <span
                                        class="text-white">#{{ initials($lotissement->titreFoncier->numero_titre_foncier) }}</span>
                                </div>
                                <div class="d-block">
                                    <span class="fw-bolder">No.
                                        {{ $lotissement->titreFoncier->numero_titre_foncier }}</span>
                            ...
                            @if (!empty($lotissement->titreFoncier))
                                <span
                                    class="fw-light badge badge-md bg-{{ $lotissement->titreFoncier->EtatTFStyle }} rounded-1 ">{{ $lotissement->titreFoncier->etat_TF }}</span>
                            @endif
                        </a>
                                ...
                                <div class="d-flex align-items-center me-3">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <h6 class="mb-0" style="font-size: small;">
                                            {{ number_format($lotissement->titreFoncier->superficie_du_TF_mere * 0.0001, 2) }}
                                            ha</h6>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center me-3 ">
                            ...
                            <div class='d-flex justify-content-between border-bottom '>
                                <a href="#" class="d-flex align-items-center  py-1">
                                    <div
                                        ...
                                        <span class="text-white"
                                            style="font-size: small;">{{ initials($lotissement->maeture) }}</span>
                                    </div>
                                    <div class="d-block">
                                        <span class="fw-bold "
                                            style="font-size: small;">{{ ucwords($lotissement->maeture) }}</span>
                                ...
                                <a href="#" class="d-flex align-items-center py-1">
                                    <div
                                        class="avatar  d-flex align-items-center justify-content-center fw-bold  rounded bg-primary me-2">
                                        <span class="text-white"
                                            style="font-size: small;">{{ initials($lotissement->promoteur_immobiliere) }}</span>
                                    </div>
                                    <div class="d-block">
                                        <span class="fw-bold "
                                            style="font-size: small;">{{ ucwords($lotissement->promoteur_immobiliere) }}</span>
                                        <div class="small text-gray" style="font-size: x-small;">
                                            <svg class="icon icon-xxs me-1" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class='d-flex justify-content-between border-bottom '>
                                <a href="#" class="d-flex align-items-center  py-1">
                                    <div
                                        class="avatar  d-flex align-items-center justify-content-center fw-bold  rounded bg-primary me-2">
                                        <span class="text-white"
                                            style="font-size: small;">{{ initials($lotissement->agent_immobiliere) }}</span>
                                    </div>
                                    <div class="d-block">
                                        <span class="fw-bold "
                                            style="font-size: small;">{{ ucwords($lotissement->agent_immobiliere) }}</span>
                                        <div class="small text-gray" style="font-size: x-small;">
                                            <svg class="icon icon-xxs me-1" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @if (!empty($lotissement->titreFoncier))
                            <div class="d-flex align-items-center mb-2">
                                <span class="fw-bolder ">{{ __('Localisation') }}</span> : <span
                                    class="fw-light mx-2"> {{ $lotissement->titreFoncier->region->region_name }} >
                                    {{ $lotissement->titreFoncier->division->division_name }} >
                                    {{ $lotissement->titreFoncier->subDivision->sub_division_name }} >
                                    {{ $lotissement->titreFoncier->lieu_dit }} </span>
                            </div>
                            <div class='mb-2'>
                                <span class="fw-bolder mt-2">{{ __('Coordonnées') }}</span> :
                                {{ $lotissement->titreFoncier->coordonnees }}
                            </div>
                        @endif
                    </div>
                    <div class="col">
                            ...
                            @foreach ($lotissement->titreFoncier->users as $key => $option)
                                <a href="#"
                                    ...
                                    <div
                                        class="avatar  d-flex align-items-center justify-content-center fw-bold  rounded bg-primary me-2">
                                        <span class="text-white"
                                            style="font-size: small;">{{ $option->initials }}</span></div>
                                    <div class="d-block">
                                        <span class="fw-bold "
                            ...
                            @if (!empty($lot))
                                <div class='row border border-1 px-3 mt-1 '>
                                    ...
                                    <span class="col py-1  text-end">
                                        <a wire:click.prevent="print({{ $lot->id }})"
                                            data-bs-toggle="modal" data-bs-target="#CreateLotSaleModal"
                                    ...
                                    @if (is_null($lot->date_de_vente) && $lot->type == 'normale')
                                        <span class="col py-1  text-end">
                                            <a wire:click.prevent="initLotData({{ $lot->id }})"
                                                data-bs-toggle="modal" data-bs-target="#CreateLotSaleModal"
                                                href="#" draggable="false">
                                                <svg class="icon icon-sm text-info" xmlns="http://www.w3.org/2000/svg"
                                                    fill="none" viewBox="0 0 24 24" stroke-width="1.5"
