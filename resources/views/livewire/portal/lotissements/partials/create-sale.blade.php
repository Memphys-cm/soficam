            ...
            <div class="modal-body p-0">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4">{{__('Vendre') }} {{ __(' Lot') }}</h1>
                        <p class="px-1"> {{__('Vendre') }} {{ __(' Lot') }} </p>
                    </div>
                    <x-form-items.form wire:submit="store">
                        ...
                        <div class='form-group row mb-3'>
                            ...
                            <div class="col">
                                ...
                                <select wire:model="type_de_versement" class="form-select @error('type_de_versement') is-invalid @enderror" id="type_de_versement" required="">
                            ...
                            <div class=" col">
                                <label for="price_per_m_square">{{ __('Prix(m²)*') }}</label>
                                <input type="number" wire:model="price_per_m_square" class="form-control  @error('price_per_m_square') is-invalid @enderror " value="{{ old('price_per_m_square') }}" placeholder="0" id="price_per_m_square" autofocus="" required="">
                                @error('price_per_m_square')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                @enderror
                        ...
                        <div class='form-group row mb-3'>
                            <div class="col">
                                ...
                                <input type="number" wire:model="superficie_vendu" class="form-control @error('superficie_vendu') is-invalid @enderror" value="{{ old('superficie_vendu') }}" placeholder="0" id="superficie_vendu" autofocus="" required="">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="superficie_restant" name="superficie_restant" value="{{ $superficie_restant ?? 0 }}" readonly>
                        ...
                        <div class='form-group row mb-3'>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="montant_restant" name="montant_restant" value="{{ $montant_restant ?? 0 }}" readonly>
                        ...
                        <div class='form-group row mb-3'>
                            <div class=" col"><label for="commentaire_du_notaire">{{ __('Commentaire') }}</label>
                                <textarea rows="3" wire:model="commentaire_du_notaire" class="form-control @error('commentaire_du_notaire') is-invalid @enderror" placeholder="Edea" id="commentaire_du_notaire" autofocus="" required="">{{ old('commentaire_du_notaire') }}</textarea>
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            <div class="col-auto">
                                <div class="text-end">
                                    <div class="d-flex my-1">
                                        ...
                                        <div class="fw-semi-bold"> {{ number_format(floatval($price_per_m_square)) }}
                                            {{ __('XAF') }}
                                        </div>
                                    </div>
                                    @if ($superficie_a_vendre === 'partielle')
                                    ...
                                    <div class="d-flex my-1">
                                        ...
                                        <div class="fw-semi-bold">
                                            {{ number_format(floatval($surperficie_du_lot)) }}
                                            {{ __('m²') }}
                                        </div>
                                    </div>
                                    @if ($type_de_versement === 'tranche')
                            ...
                            <div class="mb-4 mt-md-0">
                                <button type="submit" wire:click.prevent="update" class="btn btn-primary btn-sm btn-loading">
