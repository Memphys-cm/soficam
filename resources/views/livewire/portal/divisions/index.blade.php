    ...
    <div class='p-0'>
        <div class="d-flex justify-content-between w-100 flex-wrap align-items-center">
            <div class="mb-lg-0">
                ...
                <p class="mt-n1 mx-2">{{__('View all Divisions')}} &#x23F0; </p>
            </div>
    ...
    <div class="row p-3">
        ...
        <div class="col-md-3">
            ...
            <select wire:model="orderBy" id="orderBy" class="form-select">
                <option value="division_name_en">{{__('Division Name')}}</option>
    ...
    <div class="card pb-3">
        <div class="table-responsive  text-gray-700">
            <table class="table employee-table table-hover align-items-center ">
                <thead>
                    <tr>
                        ...
                        <th class="border-bottom">{{__('Division Name')}}</th>
                        <th class="border-bottom">{{__('Sub Divisions Count')}}</th>
            ...
            <div class='d-flex justify-content-between align-items-center pt-3 px-3 '>
                <div>
                    {{__('Showing')}} {{$perPage > $divisions_count ? $divisions_count : $perPage  }} {{__('items of')}} {{$divisions_count}}
                </div>
                {{ $divisions->links() }}
            </div>
        </div>
