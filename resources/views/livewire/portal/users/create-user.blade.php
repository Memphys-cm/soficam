            ...
            <div class="modal-body p-0">
                <div class="p-3 p-lg-4">
                    ...
                    <x-form-items.form wire:submit="store">
                        ...
                        <div class='form-group row mb-3'>
                            <div class='col'>
                                <label class="px-2" for="sexe">{{ __('Sexe') }}</label>
                        ...
                        <div class='form-group row mb-3'>
                            ...
                            <div class="col">
                                ...
                                <input type="date" wire:model="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror" value="{{ old('date_of_birth') }}" id="date_of_birth" required="">
                                @error('date_of_birth')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class='form-group row mb-3'>
                            <div class="col">
                                <label for="primary_phone_number">{{ __('N° de téléphone principal') }}</label>
                            ...
                            <div class="col">
                                <label for="secondary_phone_number">{{ __('Autre numéro de téléphone') }}</label>
