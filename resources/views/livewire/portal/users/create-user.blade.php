                    ...
                    <x-form-items.form wire:submit="store">
                        <div class='form-group row mb-3'>
                            ...
                            <div class='col'>
                                ...
                                <select wire:model="role_name" name="role_name"
                                    class="form-select  @error('role_name') is-invalid @enderror" required="">
                        ...
                        <div class='form-group row mb-3'>
                            <div class=" col"><label for="first_name">{{ __('Prenom') }}</label>
                                <input type="text" wire:model="first_name"
                                    ...
                                    value="{{ old('first_name') }}" placeholder="Jane" id="first_name" autofocus=""
                                    required="">
                                @error('first_name')
                            ...
                            <div class=" col"><label for="last_name">{{ __('Nom') }}</label>
                                <input type="text" wire:model="last_name"
                                    ...
                                    value="{{ old('last_name') }}" placeholder="Doe" id="last_name" autofocus=""
                                    required="">
                                @error('last_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class='form-group row mb-3'>
                            <div class='col'>
                                ...
                                <select wire:model="sexe" name="sexe"
                            ...
                            <div class=" col"><label for="date_of_birth">{{ __('Date de Naissance') }}</label>
                                <input type="date" wire:model="date_of_birth"
                                    ...
                                    value="{{ old('date_of_birth') }}" placeholder="Edea" id="date_of_birth"
                                    autofocus="" required="">
                                @error('date_of_birth')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="form-group row mb-3">
                            <div class="col">
                                <label for="id_card_number">{{ __('Numero CNI') }}</label>
                                <input type="text" wire:model="id_card_number"
                                    class="form-control  @error('id_card_number') is-invalid @enderror "
                                    value="{{ old('id_card_number') }}" placeholder="112233445566" id="id_card_number"
                                    autofocus="" required="">
                            ...
                            <div class="col">
                                <label for="place_of_birth">{{ __('Lieu de naissance') }}</label>
                                <input type="text" wire:model="place_of_birth"
                                    class="form-control  @error('place_of_birth') is-invalid @enderror "
                                    value="{{ old('place_of_birth') }}" placeholder="Edea" id="place_of_birth"
                                    autofocus="" required="">
                        ...
                        <div class='form-group row mb-3'>
                            <div class=" col"><label
                                    for="primary_phone_number">{{ __('N° de téléphone principal') }}</label>
                                <input type="text" wire:model="primary_phone_number"
                                    class="form-control  @error('primary_phone_number') is-invalid @enderror "
                                    value="{{ old('primary_phone_number') }}" placeholder="6xxxxxxxx"
                                    id="primary_phone_number" autofocus="" required="">
                            ...
                            <div class=" col"><label
                                    for="secondary_phone_number">{{ __('Autre numéro de téléphone') }}</label>
                                <input type="text" wire:model="secondary_phone_number"
                                    class="form-control  @error('secondary_phone_number') is-invalid @enderror "
                                    value="{{ old('secondary_phone_number') }}" placeholder="Doe"
                                    id="secondary_phone_number" autofocus="" required="">
                        ...
                        <div class='form-group row mb-3'>
                            <div class=" col"><label for="address">{{ __('Adresse') }}</label>
                                <input type="text" wire:model="address"
                                    ...
                                    value="{{ old('address') }}" placeholder="{{ __('Carefour Eto') }}"
                            ...
                            <div class=" col"><label for="email">{{ __('Adresse Email ') }}</label>
                                <input type="email" wire:model="email"
                                    ...
                                    value="{{ old('email') }}" placeholder="jane.doe@app.com" id="email"
                                    autofocus="" required="">
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class='form-group row mb-4'>
                            ...
                            <div class=" col"><label
                                    for="password_confirmation">{{ __('Confirmer mot de passe') }}</label>
                        ...
                        <div class='form-group mb-4 px-1'>
                            <div class="form-check">
                                <input class="form-check-input {{ $this->is_active ? 'checked' : '' }} "
                                    type="checkbox" value="" wire:model="is_active" id="is_active">
                                <label class="form-check-label mb-0"
                                    for="is_active">{{ __('Marquer comme actif') }}</label>
                            </div>
                        </div>
