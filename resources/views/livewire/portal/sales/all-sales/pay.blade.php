                    ...
                    <x-form-items.form wire:submit="payment">
                        ...
                        <div class='form-group mb-3 row'>
                            <div class="col">
                                ...
                                <select wire:model="payment_method"
                                    ...
                                    <option value="TresorPay">{{ __('Tresor Pay') }}</option>
                                </select>
                        ...
                        @if (in_array($payment_method, ['ORANGE', 'MTN']))
                            <div class="form-group mb-3">
                                ...
                                <input type="text" wire:model="payment_number"
                                    class="form-control @error('payment_number') is-invalid @enderror"
                                    value="{{ old('payment_number') }}" placeholder="0" id="payment_number" autofocus
                                    required>
