                    ...
                    <x-form-items.form wire:submit="store">
                        ...
                        <fieldset class="border p-3">
                            ...
                            <div class='form-group row mb-3'>
                                ...
                                <div class=" col"><label for="sub_division_id">{{ __('Arrondissement') }}</label>
                        ...
                        <fieldset class="border p-3">
                            <legend class="w-auto">Informations sur la vente</legend>
                            <div class='form-group row mb-3'>
                                ...
                                <div class=" col">
                                    <div>
                                        <div class='d-flex justify-content-between align-items-center'>
                                            ...
                                            <label for="purchaser_name">{{ __('Identité de(s) l\'acheteur (s)') }}</label>
                            ...
                            <div class='form-group row mb-3'>
                                <div class=" col"><label for="price_per_m²">{{ __('Prix(m²)*') }}</label>
                            ...
                            @if ($payment_type === 'tranche')
                                <div class='form-group row mb-3'>
                                    <div class="col">
                                        <label for="advance">{{ __('Avance') }}</label>
                            ...
                            <div class='form-group row mb-3'>
                                ...
                                <div class="col">
                                    <label for="document">{{ __('Joindre un fichier') }}</label>
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            <div class="mb-4 mt-md-0">
                                <button type="button" class="btn btn-sm btn-light text-gray-800 ms-auto "
                                    ...
                                    <span wire:click="clearFields()"
                                        class="d-none d-sm-inline-block ms-1">{{ __('Fermer') }}</span>
                                </button>
                            ...
                            <div class="col-auto fs-4">
                                <table class="table table-sm table-borderless fs--1 text-end">
                                    <tr>
                                        <th class="text-900">{{ __('Prix(m²)') }} :</th>
                                    ...
                                    <tr class="border-top">
                                        <th class="text-900">{{ __('Avance') }}:</th>
                                        <td class="fw-semi-bold">
                                    ...
                                    <tr class="border-top">
                                        <th class="text-900 h5">{{ __('Montant total') }}:</th>
