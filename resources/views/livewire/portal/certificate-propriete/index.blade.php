    ...
    <div class='p-0'>
        <div class="d-flex justify-content-between w-100 flex-wrap align-items-center">
            <div class="mb-lg-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            {{ __('Demande de Certificat de Propriété') }}</li>
                    </ol>
                </nav>
                ...
                <p class="mt-n1 mx-2">
                    {{ __('Afficher toutes les demandes de certificat de propriété dans l\'application') }}</p>
            </div>
    ...
    <div class="card pb-3">
        <div class="table-responsive  text-gray-700">
                ...
                <tbody>
                    @forelse($certificateproprietes as $certificatepropriete)
                        <tr>
                            ...
                            <td>{{ !empty($certificatepropriete->titreFoncier) ? $certificatepropriete->titreFoncier->numero_titre_foncier : '' }}
                            </td>
                                ...
                                <td>
                                    @can('certificate_propriete.update')
                                        @if ($certificatepropriete->status === 'active')
                                            <a href="#" wire:click.prevent='printPdf({{ $certificatepropriete->id }})'
                                        ...
                                        @endif
                                        @if ($certificatepropriete->status === 'active')
                                            <a href="#" wire:click.prevent='printPdfs({{ $certificatepropriete->id }})'
                                                title="Historique">
                                    ...
                                    @if ($certificatepropriete->status === 'active')
                                        <a href="#" title="Notifier"
                                            wire:click.prevent='sms({{ $certificatepropriete->id }})'>
            ...
            <div class='d-flex justify-content-between align-items-center pt-3 px-3 '>
                <div>
                    {{ __('Montrer') }}
                    {{ $perPage > $certificateproprietes_count ? $certificateproprietes_count : $perPage }}
                    {{ __('éléments sur ') }} {{ $certificateproprietes_count }}
                </div>
