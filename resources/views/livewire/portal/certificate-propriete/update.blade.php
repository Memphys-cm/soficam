                    ...
                    <x-form-items.form wire:submit="update">
                        ...
                        <div class='form-group mb-3 row'>
                            ...
                            <div class="col">
                                ...
                                <select wire:model="status" name="status" class="form-select  @error('statut') is-invalid @enderror" required="">
                                    <option value="">{{__('-- Selectionner --')}}</option>
                        ...
                        <div class='form-group mb-3 row'>
                            <div class="col">
                                <label for="certificate_propriete_reason">{{ __('Certificat Propriete Raison') }}</label>
