<div wire:ignore.self class="modal side-layout-modal fade" id="updatecertificateproprieteModal" tabindex="-1" aria-labelledby="modal-form" style="display: none;" aria-hidden="true">
            ...
            <div class="modal-body p-0">
                <div class="p-4 p-lg-5">
                    ...
                    <x-form-items.form wire:submit="update">
                        ...
                        <div class="form-group mb-3 row">
                            <div class='col'>
                                <label class="px-2" for="requestor_id">{{__('Propriators')}}</label>
                        ...
                        <div class='form-group mb-3 row'>
                            ...
                            <div class="col">
                                <label for="status">{{__('State of Land Title')}}</label>
                        ...
                        <div class='form-group mb-3 row'>
                            ...
                            <div class="col">
                                ...
                                <textarea wire:model="certificate_propriete_reason" class="form-control @error('certificate_propriete_reason') is-invalid @enderror" id="certificate_propriete_reason" autofocus=""
                                    required=""></textarea>
