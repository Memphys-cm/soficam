<div>
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap align-items-center">
            ...
            <div class="d-flex justify-content-between mb-2">
                ...
                @can('titre_foncier.create')
                    <a href="#" data-bs-toggle="modal" data-bs-target="#CreateTitreFoncierModal"
                        class="btn btn-sm btn-primary py-2 d-inline-flex align-items-center mx-2">
                        <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="btn-group me-2">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item"
                                href="{{ route('portal.lotissements.index') }}">{{ __('Lotissement') }}</a>
                            <a class="dropdown-item"
                                href="{{ route('portal.lotissements.index') }}">{{ __('Ventes') }}</a>
                            <a class="dropdown-item"
                                href="{{ route('portal.mutation-totale.index') }}">{{ __('Mutation totale') }}</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item"
                                href="{{ route('portal.immobilier.index') }}">{{ __('Releve Immo') }}</a>
                            <a class="dropdown-item"
                                href="{{ route('portal.certificate-propriete.index') }}">{{ __('Certificat Proprieté') }}</a>
                            <a class="dropdown-item"
                                href="{{ route('portal.titre-fonciers-charges.index') }}">{{ __('Charges') }}</a>
                            <a class="dropdown-item"
                                href="{{ route('portal.etat-cession.index') }}">{{ __('Etat Cession') }}</a>
                        </div>
                    </div>
                @endcan
    ...
    <div class="row py-3">
        <div class="col-md-2">
            <label for="region_ids">{{ __('Par Région') }}: </label>
            <select wire:model="region_ids" id="region_ids" class="form-select">
        ...
        <div class="col-md-2">
            <label for="division_ids">{{ __('Par Division') }}: </label>
            <select wire:model="division_ids" id="division_ids" class="form-select">
                            ...
                            <td>
                                ...
                                <div class="d-flex align-items-centerpy-1">
                                    {{ __('Lieu Dit') }} : <span class="fw-bolder mx-2">
                                        {{ $titrefoncier->land ? $titrefoncier->land->name : '' }} </span>
                                </div>
                            </td>
                            <td>
                                <span class="fw-bolder mx-2">
                                    {{ number_format($titrefoncier->land->market_value * $titrefoncier->superficie_du_TF_mere, 0, ',', '.') }}
                                    {{ __('Fcfa') }}</span>
                                    <span>({{number_format($titrefoncier->land->market_value, 0, ',', '.')}}f/m2)</span>
                            </td>
                            <td>
                                <div class="d-flex align-items-centerpy-1">
