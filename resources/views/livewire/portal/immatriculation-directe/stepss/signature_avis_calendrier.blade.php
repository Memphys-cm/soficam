                ...
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="statusDate"
                            wire:model="status_apres_publication_date" {{ $visibility }}>
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="calendarSwitch" wire:model="calendarDecision"
                            @if (!$status_apres_publication) disabled @endif>
                        <label class="form-check-label" for="calendarSwitch">Décision portant calendrier de descente sur
                            terrain</label>
                    ...
                    <div class="mb-3">
                        <label for="calendarDecisionDate" class="form-label">Date de la Décision concernant le
                            calendrier</label>
                        <input type="date" class="form-control" id="calendarDecisionDate"
                            wire:model="calendarDecision_date" @if (!$status_apres_publication) disabled @endif>
