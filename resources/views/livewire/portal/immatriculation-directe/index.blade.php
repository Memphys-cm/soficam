            ...
            <table class="table employee-table table-bordered table-hover align-items-center ">
                ...
                <tbody>
                    @forelse($imma_directes as $imma_directe)
                        ...
                        <td>
                            <span class="fw-normal badge super-badge p-2 bg-{{$imma_directe->StatutStyle}} round">{{$imma_directe->statut}}</span>
                        </td>
                        <td>
                            <span class="fw-normal badge super-badge p-2 bg-secondary"> {{$imma_directe->next_step}} </span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <a href="#"  data-bs-placement="top" title="Coter le Dossier Ici" wire:click.prevent="initData({{$imma_directe->id}})" data-bs-toggle="modal" data-bs-target="#CotationImmaDirecteModal" draggable="false">
                                <svg class="icon icon-sm text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                            </a>
                            ...
                            <a href="#"  data-bs-placement="top" title="Etablisser L'ordre de Versement" wire:click.prevent="initData({{$imma_directe->id}})" data-bs-toggle="modal" data-bs-target="#OrdreVersementImmaDirecteModal" draggable="false">
                            ...
                            @can('imma_directe.avis', $imma_directe)
                                ...
                                @endif
                            @endcan
                            @can('imma_directe.certificat', $imma_directe)
                            <a href="#" data-bs-placement="top" title="Imprimer Le Certificat D'Affichage" wire:click.prevent="initData({{$imma_directe->id}})" data-bs-toggle="modal" data-bs-target="#CertfifcatAffichageImmaDirecteModal" draggable="false">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 -13 54 54" stroke-width="1.5" stroke="currentColor" >
                            ...
                            <a href="#" data-bs-placement="top" title="Imprimer La convocation D'Invitation sur le Terrain" wire:click.prevent="initData({{$imma_directe->id}})" data-bs-toggle="modal" data-bs-target="#ConvocationImmaDirecteModal" draggable="false">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 -13 54 54" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 13.5l3 3m0 0l3-3m-3 3v-6m1.06-4.19l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" />
                                  </svg>                                                                
                            </a>
                                @if ($imma_directe->next_step == "Convocation D'invitation sur Le Terrain")
