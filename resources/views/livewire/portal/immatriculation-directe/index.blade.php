                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Voir Les Deatils du Dossier" >
                            ...
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Coter le Dossier Ici" wire:click.prevent="initData({{$imma_directe->id}})" data-bs-toggle="modal" data-bs-target="#CotationImmaDirecteModal" draggable="false">
                            ...
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Etablisser L'ordre de Versement" wire:click.prevent="initData({{$imma_directe->id}})" data-bs-toggle="modal" data-bs-target="#OrdreVersementImmaDirecteModal" draggable="false">
                            ...
                            @endif
                            @endcan
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Generer L'Avis au Publique" wire:click.prevent="initData({{$imma_directe->id}})" data-bs-toggle="modal" data-bs-target="#OrdreVersementImmaDirecteModal" draggable="false">
