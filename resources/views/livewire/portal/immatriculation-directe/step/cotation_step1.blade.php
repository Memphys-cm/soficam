        ...
        <x-form-items.form wire:submit="cotation_first_step">
            <div class="form-group mb-3 row">
                ...
                <div class="col-12 my-1">
                    ...
                    <textarea wire:model="observation" class="form-control  @error('observation') is-invalid @enderror" name=""
                        id="" cols="30" rows="10">
                                        </textarea>
                    @error('observation')
                        <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" wire:click.prevent="cotation_first_step" class="btn btn-primary btn-loading"
