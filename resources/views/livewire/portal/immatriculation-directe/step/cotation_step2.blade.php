<div wire:ignore.self class="modal side-layout-modal fade" id="CotationIStep2mmaDirecteModal" tabindex="-1"
            ...
            <div class="modal-body p-0">
                <div class="p-4 p-lg-5">
                    <div class="mb-4 mt-md-0">
                        ...
                        <p class="px-1">
                            {{__('Coter') }}{{ __(' un Dossier D\'Immatriculation Directe à la Délégation Départementale') }}
                        </p>
                    </div>
                    <x-form-items.form wire:submit="cotation_second_step">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" wire:click.prevent="cotation_second_step"
                                class="btn btn-primary btn-loading"
                                wire:loading.attr="disabled">{{__('Coter le Dossier')}}</button>
                        </div>
                    </x-form-items.form>
                </div>
            </div>
