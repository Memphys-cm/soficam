             ...
             <div class="modal-body p-0">
                 <div class="p-3 p-lg-4">
                     <div class="mb-4 mt-md-0">
                         ...
                         <p>{{__('Importer de nouveaux :nom du fichier excel',['nom'=>__('Entreprise')])}} &#128522;</p>
                     </div>
                     <x-form-items.form wire:submit="import" class="form-modal">
                         ...
                         <div class='mb-4'>
                             <ol>
                                 <li>{{__('Telechargement simple :nom modèle d\'importation',['nom'=>__('Entreprise')])}} <a href="{{asset('templates/import_companies.xlsx')}}">{{__('Template')}}</a></li>
                                 <li>{{__('Remplir le modèle avec votre :données nominatives',['nom'=>__('Entreprise')])}}</li>
