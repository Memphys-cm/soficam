            ...
            <div class="modal-body p-0">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4">{{$state ? 'Update' : 'Create'}} {{__(' Region')}}</h1>
                        <p class="px-1"> {{$state ? 'Update' : 'Create'}} {{__(' Region')}} &#128522;</p>
                    </div>
                    <x-form-items.form wire:submit="store">
                        ...
                        <div class="form-group mb-3">
                            <label for="name">{{__('Region Name ')}} <span>({{__('French')}})</span></label>
                        ...
                        <div class='form-group mb-4 px-1'>
                            <div class="form-check">
                                ...
                                <label class="form-check-label mb-0" for="region.status">{{ __('Mark as Active') }}</label>
                            </div>
                        </div>
