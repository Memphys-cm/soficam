                            ...
                            @canany('titre_foncier.update', 'titre_foncier.delete')
                                <td>
                                    ...
                                    @can('titre_foncier.update')
                                            ...
                                            <button wire:click.prevent="initData({{ $titrefoncier->id }})" data-bs-toggle="modal" data-bs-target="#paiement"  class="btn btn-primary btn-sm" draggable="false">Paiement</button>
