                    ...
                    <div class="card-body">
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-8 px-xl-0">
                                ...
                                <div class="small d-flex mt-1">
                                    <div>{{ \Str::plural(__('Journal de création'), $creation_log_count) }} {{__('Enregistrées')}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row d-block d-xl-flex align-items-center">
                            <div class="col-12 col-xl-4 text-xl-center mb-2 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                                ...
                                <div class="d-sm-none">
                                    <h2 class="fw-extrabold h5">{{ \Str::plural(__('Journal des Modifications'), $update_log_count) }}</h2>
                                    <h3 class="mb-1">{{numberFormat($update_log_count)}}</h3>
                                </div>
                            </div>
                            <div class="col-12 col-xl-8 px-xl-0">
                                <a href="" class="d-none d-sm-block">
                                    <h2 class="h5">{{ \Str::plural(__('Journal des Modifications'), $update_log_count) }}</h2>
                                    <h3 class="fw-extrabold mb-1">{{numberFormat($update_log_count)}}</h3>
                                </a>
                                <div class="small d-flex mt-1">
                                    <div>{{ \Str::plural(__('Journal des Modifications'), $update_log_count) }} {{__('Enregistrées')}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-8 px-xl-0">
                                ...
                                <div class="small d-flex mt-1">
                                    <div>{{ \Str::plural(__('Journal des suppressions'), $deletion_log_count) }} {{__('Enregistrées!')}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
