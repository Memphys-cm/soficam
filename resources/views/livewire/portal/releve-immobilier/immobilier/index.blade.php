            ...
            <table class="table employee-table table-hover align-items-center ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $immobilier->price }} {{ __('XAF') }}</td>
                        <td>{{ $immobilier->validity }}</td>
                        ...
                        <a href="#" title="Télécharger document" wire:click='printPdf({{$immobilier->id}})'>
                        ...
                        <a href='#' wire:click.prevent="initData({{ $immobilier->id }})" data-bs-toggle="modal" data-bs-target="#DeleteModal">
