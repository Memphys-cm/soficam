            ...
            <div class="modal-body p-0">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4"> {{ __('Real Estate') }}</h1>
                        <p class="px-1"> {{ __('Create a real estate') }} &#128522;</p>
                    </div>
                    <x-form-items.form wire:submit="store">
                        <fieldset class="border p-3 mb-5 rounded">
                            ...
                            <div class='form-group row mb-3'>                                
                                <div class=" col">
                                    <label for="releve_number">{{ __('Real Estate Number') }}</label>
                                ...
                                <div class=" col"><label for="requestor_id">{{ __('Requestor') }}</label>
                            ...
                            <div class='form-group row mb-3'>
                                <div class=" col"><label for="price">{{ __('Price (XAF)') }}</label>
                                ...
                                <div class=" col">
                                    ...
                                    <select wire:model="releves_type" class="form-control" name="releves_type" id="releves_type">
                                        ...
                                        <option value="personne_physique">Physical Person</option>
                                        <option value="personne_morale">Moral Person</option>
                                    </select>
                                    @error('releves_type')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="form-group row mb-3 px-2">
                                <label for="releve_reason">Why did you wanted to create this real estate ?</label>
                        ...
                        <div class="d-flex align-items-end mt-5 d-flex justify-content-end">
                            ...
                            <button type="submit" wire:click.prevent="" class="btn btn-primary btn-sm btn-loading">
                                <span class="d-none d-sm-inline-block ms-1">{{ __('Edit') }}</span>
                            </button>
                        </div>
