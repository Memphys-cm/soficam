                        ...
                        <fieldset class="border p-3 rounded">
                            ...
                            <div class='row form-group mb-3'>
                                ...
                                <div class="col-md-6 py-2">
                                    ...
                                    <select wire:model="subdivision_id" name="ssubdivision_id"
                                ...
                                <div class="col-md-6 py-2">
                                    ...
                                    <select wire:model="state_assignment.status" name="state_assignment.status"
                                    class="form-select  @error('state_assignment.status') is-invalid @enderror" >
                                ...
                                <div class="col-md-6 py-2">
                                    ...
                                    <x-input.select wire:model="geometre_id" prettyname="geometre_id" :options="$geometres->pluck('first_name', 'id')->toArray()"
                                        selected="('geometre_id')" />
                                    @error('geometre_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6 py-2">
                                    ...
                                    <select wire:model="state_assignment.type_personne" name="state_assignment.type_personne"
                                    class="form-select  @error('state_assignment.type_personne') is-invalid @enderror">
                                ...
                                <div class="col-md-6 py-2">
                                    ...
                                    <select wire:model="state_assignment.type_operation" name="state_assignment.type_operation"
                                    class="form-select  @error('state_assignment.type_operation') is-invalid @enderror">
                                ...
                                <div class="col-md-6 py-2">
                                    ...
                                    <select wire:model="state_assignment.zone" name="state_assignment.zone"
                                    class="form-select  @error('state_assignment.zone') is-invalid @enderror">
