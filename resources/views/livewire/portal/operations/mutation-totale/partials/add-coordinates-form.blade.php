<div wire:ignore.self class="modal side-layout-modal fade" id="CreateAddCoordinatesModal" tabindex="-1" aria-labelledby="modal-form" style="display: none;" aria-hidden="true">
