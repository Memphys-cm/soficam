                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center ">
                        <div class="bg-white shadow border-0 rounded border-light p-4 px-lg-5 pt-lg-4 pb-lg-5 col-md-7 col-sm-12">
                            ...
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">{{ __('Sign Up')}}</h1>
                            </div>
                            <x-form-items.form method="POST" action="{{ route('register') }}" class="mt-1 form-modal needs-validation" id="">
                                ...
                                <div class='form-group row mb-3'>
                                    ...
                                    <div class=" col"><label for="date_of_birth">{{ __('Place of Birth') }}</label>
                                ...
                                <div class="d-flex justify-content-between align-items-end mt-3 mb-4 ">
                                    <span class="fw-normal">{{__('Already have an account?')}} <a href="{{route('login')}}" class="fw-bold">{{__('Sign In')}}</a></span>
                                    <button type="submit" class="btn btn-primary btn-loading px-6"> {{ __('Register') }}</button>
                                </div>
                            </x-form-items.form>
