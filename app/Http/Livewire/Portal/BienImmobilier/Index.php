...
class Index extends Component
{
    ...
    public function sms($id) {
        $bien_immobilier = ReleveImmobilier::findOrFail($id);
        $receiver = $bien_immobilier->requestor->first_name;
        $sms = "Mr/Mme. $receiver votre relevé de bien immobilier est disponible";
        $senderid ='SOFICAM';
        $mobiles = $bien_immobilier->requestor->primary_phone_number;
