...
namespace App\Http\Livewire\Portal\ReleveImmobilier\BiensImmobiliers;
...
class Index extends Component
{
    ...
    public function update()
    {
        ...
        $this->refresh(__('Bien immobilier mis à jour !'), 'EditEstateModal');
    ...
    public function  printPdf($id)
    {
        ...
        $pdf = Pdf::loadView('livewire.portal.releve-immobilier.biens-immobiliers.print',$data)->setPaper('a4', 'portrait');
    ...
    public function render()
    {
        ...
        return view('livewire.portal.releve-immobilier.biens-immobiliers.index', [
