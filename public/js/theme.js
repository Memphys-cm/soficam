...
d.addEventListener("DOMContentLoaded", function (event) {
    ...
    */
    ...
    // multiple
    var selectStatesInputEl = d.querySelector('#multiple');
    ...
    if (sidebar) {
        if (localStorage.getItem('sidebar') === 'contracted') {
            ...
            fullLogo.classList.add('notransition');
            smallLogo.classList.add('notransition');
            ...
            setTimeout(function () {
                ...
                fullLogo.classList.remove('notransition');
                smallLogo.classList.remove('notransition');
            }, 500);
